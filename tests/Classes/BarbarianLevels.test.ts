  ...
  describe("on leveling", () => {
    ...
    describe("to Level 3", () => {
      ...
      describe("with Totem Warrior archetype", () => {
        ...
        test("gains Bear, Eagle, or Wolf feature traits", () => {
          const pc1: PlayerCharacter = new PlayerCharacter(
            12,
            12,
            12,
            12,
          ...
          const pc2: PlayerCharacter = new PlayerCharacter(
            12,
            12,
            12,
            12,
          ...
          const pc3: PlayerCharacter = new PlayerCharacter(
            12,
            12,
            12,
            12,
    ...
    describe("to Level 10", () => {
      describe("with Berserker archetype", () => {
        test("gains the Intimidating Presence feature trait", () => {
          ...
          expect(
            pc.findFeatureTraitByName("Intimidating Presence")
          ).toBeTruthy();
        });
      });
    ...
    describe("to Level 20", () => {
      ...
      test("upgrades max Rages to Infinity", () => {
        expect(pc.findResourceTraitByName("Rage").resourceMax.value).toBe(
          Infinity
        );
      });
    });
