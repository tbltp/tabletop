...
describe("Bard Class", () => {
  ...
  describe("on initialization (Level 1):", () => {
    ...
    test("gains proficiency in Light armor", () => {
      expect(pc.traits.armorProficiencies).toIncludeAllMembers(["Light"]);
    });
  ...
  describe("on leveling", () => {
    ...
    const bdArgs = (college: string): BardLevelingParams[] => [
      ...
      {
        isNoInput: false,
        spellSelection: ["FAERIE FIRE"],
      },
      {
        isNoInput: false,
        spellSelection: ["KNOCK"],
        archetypeSelection: [
          {
            archetype: college,
          },
        ],
        proficiencySelection: ["performance", "persuasion"],
      },
      {
        isNoInput: false,
        spellSelection: ["TRUE STRIKE", "SUGGESTION"],
      ...
      {
        isNoInput: false,
        spellSelection: ["DIMENSION DOOR"],
      },
      {
        isNoInput: false,
        spellSelection: ["CONFUSION"],
        abilityScoreImprovement: [
          {
            ability: "charisma",
            improvement: 1,
      ...
      {
        isNoInput: false,
        spellSelection: ["DREAM"],
      },
      {
        isNoInput: false,
        spellSelection: ["MENDING"],
        proficiencySelection: ["intimidation", "deception"],
        magicalSecretsSpellSelection: ["TELEKINESIS", "INSECT PLAGUE"],
      },
      {
        isNoInput: false,
        spellSelection: ["MASS SUGGESTION"],
      },
      {
        isNoInput: false,
        abilityScoreImprovement: [
      ...
      {
        isNoInput: false,
        spellSelection: ["MIRAGE ARCANE"],
      },
      {
        isNoInput: false,
        magicalSecretsSpellSelection: ["FIRE STORM", "HEAL"],
      },
      {
        isNoInput: false,
        spellSelection: ["POWER WORD STUN"],
      },
      {
        isNoInput: false,
        abilityScoreImprovement: [
      ...
      {
        isNoInput: false,
        spellSelection: ["POWER WORD KILL"],
      },
      {
        isNoInput: false,
        magicalSecretsSpellSelection: ["CREATION", "CRUSADER'S MANTLE"],
      },
      {
        isNoInput: false,
        abilityScoreImprovement: [
    ...
    describe("to Level 5", () => {
      ...
      test("upgrades Bardic Inspiration dice to 1d8", () => {
        expect(pc.findResourceTraitByName("Bardic Inspiration").dice).toBe(
          "1d8"
        );
      });
    ...
    describe("to Level 6", () => {
      ...
      describe("with College of Lore archetype", () => {
        ...
        test("gains the Additional Magical Secrets feature trait", () => {
          expect(
            pc.findFeatureTraitByName("Additional Magical Secrets")
          ).toBeTruthy();
        });
    ...
    describe("to Level 10", () => {
      ...
      test("can learn spells of other classes through Magical Secrets", () => {
        expect(
          pc.findFeatureTraitByName("Magical Secrets").choices.length
        ).toBe(2);
      });
