...
export class Thief {
    ...
    static thief3(pc: PlayerCharacter, params: LevelingParams) {
        pc.addFeatures(Thief.getFeature("3", "FAST HANDS"), Thief.getFeature("3", "SECOND-STORY WORK"));
      }
    
      static thief9(pc: PlayerCharacter, params: LevelingParams) {
        pc.addFeatures(Thief.getFeature("9", "SUPREME SNEAK"));
      }
    
      static thief13(pc: PlayerCharacter, params: LevelingParams) {
        pc.addFeatures(Thief.getFeature("13", "USE MAGIC DEVICE"));
      }
    
      static thief17(pc: PlayerCharacter, params: LevelingParams) {
        pc.addFeatures(Thief.getFeature("17", "THIEF'S REFLEXES"));
      }
}