...
export class Charlatan extends Background {
    constructor(){
        super(
            ...
            ["DISGUISE KIT"],
            15,
            [{"title": "False Identity", "description": "You have created a second identity that includes documentation, established acquintances, and disguises that allow you to assume that persona, Additionally, you can forge documents including official papers and personal letters, as long as you have seen an example of the kind of document or the handwriting you are trying to copy."}, {"title": "Con of Your Choice", "description": "Ten stoppered bottles filled colored liquid, a set of weighted diece, or a signet ring of an imaginary duke.)"}] 
        );
    }
}
...
export class FolkHero extends Background {
    constructor(artisansToolProficiency: string, artisansTool: string){
        super(
            ...
            [artisansTool],
            10,
            [{"title": "Rustic Hospitality", "description": "Since you come from the ranks of the common folk, you fit in among them with ease. You can find a place to hide, rest, or recuperate among other commoners, unless you have shown yourself to be a danger to them. They will shield you from the law or anyone else searching for you, though they will not risk their lives for you."}]
        );
    }
}
...
export class Outlander extends Background {
    constructor(musicalInstrument: string, language: string){
        super(
            ...
            [],
            10,
            [{"title": "Wanderer", "description": "You have an excellent memory for maps and geography, and you can always recall the general layout of terrain, settlements, and other features around you. In addition, you can find food and fresh water for yourself and up to five other people each day, provided that the land offers berries, small game, water, and so forth."}]
        );
    }
}
...
export class Sage extends Background {
    constructor(languages: string[]){
        super(
            ...
            [],
            10,
            [{"title": "Research", "description": "When you attempt to learn or recall a piece of lore, if you do not know that information, you often know where and from whom you can obtain it. Usually, this information comes from a library, scriptorium, university, or a sage or other learned person or creature."}] 
        );
    }
}
...
export class Sailor extends Background {
    constructor(){
        super(
            ...
            [],
            10,
            [{"title": "Ship's Passage", "description": "When you need to, you can secure free passage on a siling ship for yourself and your adventuring companions. You might sail on the ship you served on, or another ship you have good relations with (perhaps one captained by former crewmate). Because you're calling in a favor, you can't be certain of a schedule or route that will meet your every need. In return for your free passage, you and your companions are expected to assist the crew during voyage."}]
        );
    }
}
...
export class Soldier extends Background {
    constructor(gamingSet: string){
        super(
            ...
            [],
            10,
            [{"title": "Military Rank", "description": "You have a military rank from your career as a soldier. Soldiers loyal to your former military organization still recognize your authority and influence. and they defer to you if they are of a lower rank. You can invoke your rank to exert influence over other soldiers and requisition simple equipment or horses for temporary use. You can also usually gain access to friendly military encampments and fortresses where your rank is recognized."}] 
        );
    }
}
...
export class Urchin extends Background {
    constructor(){
        super(
            ...
            [],
            10,
            [{"title": "City Secrets", "description": "You know the secret patterns and flow to cities and can find passages through the urban sprawl that other would miss. When you are not in combat, you (and companions you lead) can travel between any two locations in the city twice as fast as your speed would normally allow."}]
        );
    }
}