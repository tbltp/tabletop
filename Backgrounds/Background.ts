...
export class Acolyte extends Background {
    constructor(languages: string[], holySymbol: string){
        ...
        this.equipment.push(holySymbol);
    }
...
export class Criminal extends Background {
    ...
    equipment = ["CROWBAR", "CLOTHES, COMMON"];
    toolKits = [];
    gp = 15;
...
export class Entertainer extends Background {
    constructor(musicalInstrumentProficiency: string, musicalInstrument: string){
        super();
        this.toolProficiencies.push(musicalInstrumentProficiency);
        this.toolKits = [musicalInstrument];
    }
...
export class FolkHero extends Background {
    constructor(artisansToolProficiency: string, artisansTool: string){
        super();
        this.toolProficiencies.push(artisansToolProficiency);
        this.toolKits = [artisansTool];
    }
...
export class GuildArtisan extends Background {
    constructor(artisansToolProficiency: string, artisansTool: string, language: string){
        super();
        this.toolProficiencies = [artisansToolProficiency];
        this.toolKits = [artisansTool];
...
export class Hermit extends Background {
    ...
    toolKits = ["HERBALISM KIT"];
    equipment = ["CLOTHES, COMMON", "BLANKET"];
    gp = 5;
...
export class Noble extends Background {
    ...
    languages: string[];
    toolProficiencies: string[];
    equipment = ["CLOTHES, FINE", "SIGNET RING"];
    gp = 25;
    toolKits = [];
...
export class Outlander extends Background {
    ...
    languages: string[];
    toolProficiencies: string[];
    equipment = ["STAFF", "HUNTING TRAP", "CLOTHES, TRAVELER'S"];
    toolKits = [];
    gp = 10;
...
export class Sage extends Background {
    ...
    languages: string[];
    toolProficiencies = [];
    equipment = ["INK (1 OUNCE BOTTLE)", "INK PEN", "CLOTHES, COMMON"];
    toolKits = [];
    gp = 10;
...
export class Sailor extends Background {
    ...
    equipment = ["ROPE, SILK (50 FEET)", "CLOTHES, COMMON"];
    toolKits = [];
    gp = 10;
