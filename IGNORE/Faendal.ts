...
const pclass = new Ranger(["Insight", "Perception", "Stealth"], ["DAGGER", "SPEAR"], ["LEATHER"], {isNoInput: false, favoredEnemy: "Enemies of Nature", favoredTerrain: "Forest"}, "EXPLORER");
const background = new FolkHero("Leatherworker's Tools,", "LEATHERWORKER'S TOOLS");
race.apply(pc)
pclass.apply(pc)
background.apply(pc)
