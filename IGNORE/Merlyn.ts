...
const pclass = new Cleric(["persuasion", "insight"], ["MACE", "GREATCLUB"], ["LEATHER", "SHIELD"], {isNoInput: false, spellSelection: ["LIGHT", "MENDING", "SPARE THE DYING"], proficiencySelection: ["religion", "history"], archetypeSelection: [{archetype: "KNOWLEDGE", options: ["Sylvan", "Elvish"]}]}, "EXPLORER");
